...
If we look at the first row, this can be interpreted as:

> There were `r brolga_counts$n[1]` sightings of a brolga in year: `r brolga_counts$year[1]`, month: `r brolgar_counts$month[1]` (January).
