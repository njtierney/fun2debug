...
We can look at a general sense of this by looking at the data - looking at the proportion of people studying in each year, for all age groups and states:
...
- An error message tells you what stopped, and often names a place you did not write
- Guessing at the cause and then testing the guess is a reasonable first move
- It stops telling you things once you need to know what a value was
...
If we wrote this out as a script:
...
The process did work. But it is also a bit of a missed opportunity to explore the function. It also has some shortfalls:
...
Imagine we had our function like this:
...
You can also run the code inside the function. You can view the browser() help with `help`. This reveals this little map of commands:
